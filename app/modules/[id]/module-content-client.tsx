...
import { module1Lessons, module2Lessons, module3Lessons, module4Lessons, module5Lessons, module6Lessons, module7Lessons, module8Lessons } from "@/lib/lesson-data"
...
export default function ModuleContentClient({ id }: { id: string }) {
  ...
  const isLessonModule = id === "1" || id === "2" || id === "3" || id === "4" || id === "5" || id === "6" || id === "7" || id === "8"
  const lessonsForModule = id === "1" ? module1Lessons : id === "2" ? module2Lessons : id === "3" ? module3Lessons : id === "4" ? module4Lessons : id === "5" ? module5Lessons : id === "6" ? module6Lessons : id === "7" ? module7Lessons : id === "8" ? module8Lessons : []
