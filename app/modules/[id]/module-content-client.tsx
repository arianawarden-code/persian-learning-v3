...
import { module1Lessons, module2Lessons, module3Lessons, module4Lessons, module5Lessons, module6Lessons, module7Lessons, module8Lessons, module9Lessons, module10Lessons, module11Lessons, module12Lessons } from "@/lib/lesson-data"
...
export default function ModuleContentClient({ id }: { id: string }) {
  ...
  const isLessonModule = id === "1" || id === "2" || id === "3" || id === "4" || id === "5" || id === "6" || id === "7" || id === "8" || id === "9" || id === "10" || id === "11" || id === "12"
