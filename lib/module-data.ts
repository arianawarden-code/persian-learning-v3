  ...
  2: {
    ...
    grammar: [
      ...
      // Lesson 2: "Pronouns with the verb 'to be'"
      {
        ...
        pattern: "من + دانشجو + هستم",
        patternParts: ["من", "دانشجو", "هستم"],
        patternExamples: [
        ...
        note: "Remember: Persian is read right to left! The Persian word order is: pronoun, then what you are, then the verb. In English we say 'I am a student' but in Persian it's 'من دانشجو هستم' (I student am). The verb always goes at the end! It changes with each pronoun: هستم (I am), هستی (you are), است (he/she is), هستید (you are - formal), هستیم (we are), هستند (they are).",
