...
//module 10
  ...
  18: {
    ...
    vocabulary: [
      ...
      {
        persian: "اَبرو",
        transliteration: "abru",
        english: "eyebrow",
        example: "اَبروهایَم سیاه اَست.",
        exampleTranslation: "My eyebrows are black.",
      },
      {
        persian: "لَب",
        transliteration: "lab",
        english: "lip",
        example: "لَبَم خُشک اَست.",
        exampleTranslation: "My lip is dry.",
      },
      {
        persian: "بَدَن",
      ...
      {
        persian: "آرَنج",
        transliteration: "āranj",
        english: "elbow",
        example: "آرَنجَم دَرد می‌کُنَد.",
        exampleTranslation: "My elbow hurts.",
      },
      {
        persian: "مُچ",
      ...
      },
      {
        ...
        example: "کَمَرَم دَرد دارَد.",
        exampleTranslation: "My lower back hurts.",
      },
      {
        persian: "پا",
        transliteration: "pā",
      ...
      {
        persian: "قوزَک",
        transliteration: "ghuzak",
        english: "ankle",
        example: "قوزَکَم دَرد می‌کُنَد.",
        exampleTranslation: "My ankle hurts.",
      },
      {
        persian: "قَلب",
    ...
    grammar: [
      {
        id: 0,
        type: "pattern-intro" as const,
        instruction: "Learn how to say a body part hurts",
        teachingContent: {
          title: "Saying a Body Part Hurts",
          explanation: "To say a body part hurts, attach the possessive suffix ـَم (-am = my) directly to the body part, then add دَرد می‌کُنَد (dard mikonad = hurts). For example: سَر (head) → سَرَم (my head) → سَرَم دَرد می‌کُنَد (my head hurts). This is how you tell a doctor or someone what hurts.",
          examples: [
            { label: "My head hurts", persian: "سَرَم دَرد می‌کُنَد", description: "saram dard mikonad" },
            { label: "My tooth hurts", persian: "دَندونَم دَرد می‌کُنَد", description: "dandunam dard mikonad" },
            { label: "My ear hurts", persian: "گوشَم دَرد می‌کُنَد", description: "goosham dard mikonad" },
          ],
        },
        question: "How do you say 'My head hurts'?",
        options: ["سَرَم دَرد می‌کُنَد", "سَر دَرد می‌کُنَد", "مَن سَر دَرد دارَم", "دَرد سَرَم می‌کُنَد"],
        correctAnswer: 0,
        explanation: "The pattern is: [body part] + َم + دَرد می‌کُنَد. So 'My head hurts' is سَرَم دَرد می‌کُنَد.",
        pattern: "[body part] + َم + دَرد می‌کُنَد",
        patternTransliteration: "[body part] + -am + dard mikonad",
        patternParts: ["[body part]", "َم", "دَرد می‌کُنَد"],
        patternExamples: [
          { persian: "سَرَم دَرد می‌کُنَد", transliteration: "saram dard mikonad", english: "My head hurts" },
          { persian: "دَندونَم دَرد می‌کُنَد", transliteration: "dandunam dard mikonad", english: "My tooth hurts" },
          { persian: "گوشَم دَرد می‌کُنَد", transliteration: "goosham dard mikonad", english: "My ear hurts" },
        ],
        note: "The suffix ـَم (-am) means 'my'. You can change it: ـَت (-at = your), ـَش (-ash = his/her). For example: سَرَت دَرد می‌کُنَد (your head hurts), سَرَش دَرد می‌کُنَد (his/her head hurts).",
      },
      {
        id: 1,
        type: "pattern-intro" as const,
        instruction: "Learn how to give simple commands about body parts",
        teachingContent: {
          title: "Giving Simple Body Commands",
          explanation: "To tell someone to do something with a body part, use the imperative (command) form. Add بِـ (be-) to the verb stem to make a command. Put the body part with ـَت (-at = your) first, then را (rā = object marker), then the command verb.",
          examples: [
            { label: "Close your eyes", persian: "چِشمَت را بِبَند", description: "cheshmat rā beband" },
            { label: "Open your mouth", persian: "دَهانَت را باز کُن", description: "dahānat rā bāz kon" },
            { label: "Wash your hands", persian: "دَستَت را بِشور", description: "dastat rā beshur" },
          ],
        },
        question: "How do you say 'Close your eyes'?",
        options: ["چِشمَت را بِبَند", "بِبَند چِشمَت را", "چِشم بِبَند", "چِشمَت بِبَند را"],
        correctAnswer: 0,
        explanation: "The pattern is: [body part]َت + را + [imperative verb]. So 'Close your eyes' is چِشمَت را بِبَند.",
        pattern: "[body part]َت + را + [imperative verb]",
        patternTransliteration: "[body part]-at + rā + [imperative verb]",
        patternParts: ["[body part]َت", "را", "[imperative verb]"],
        patternExamples: [
          { persian: "چِشمَت را بِبَند", transliteration: "cheshmat rā beband", english: "Close your eyes" },
          { persian: "دَهانَت را باز کُن", transliteration: "dahānat rā bāz kon", english: "Open your mouth" },
          { persian: "دَستَت را بِشور", transliteration: "dastat rā beshur", english: "Wash your hands" },
        ],
        note: "را (rā) is the direct object marker — it comes after the thing being acted on. The prefix بِـ (be-) turns a verb into a command. باز کُن (bāz kon) means 'open' and بِبَند (beband) means 'close'.",
      },
      {
        id: 2,
        type: "pattern-intro" as const,
        instruction: "Learn how to say something is good or bad for a body part",
        teachingContent: {
          title: "Saying Something Is Good or Bad for You",
          explanation: "To say something is good or bad for a body part, use بَرایِ (barāye = for). Put what is good/bad first, then بَرایِ, then the body part, then خوب (good) or بَد (bad) + اَست (is).",
          examples: [
            { label: "Water is good for the skin", persian: "آب بَرایِ پوست خوب اَست", description: "āb barāye poost khub ast" },
            { label: "Exercise is good for the heart", persian: "وَرزِش بَرایِ قَلب خوب اَست", description: "varzesh barāye ghalb khub ast" },
            { label: "Fruit is good for the body", persian: "میوه بَرایِ بَدَن خوب اَست", description: "mive barāye badan khub ast" },
          ],
        },
        question: "How do you say 'Water is good for the skin'?",
        options: ["آب بَرایِ پوست خوب اَست", "پوست بَرایِ آب خوب اَست", "آب خوب بَرایِ پوست اَست", "بَرایِ پوست آب خوب اَست"],
        correctAnswer: 0,
        explanation: "The pattern is: [noun] + بَرایِ + [body part] + خوب/بَد + اَست. So 'Water is good for the skin' is آب بَرایِ پوست خوب اَست.",
        pattern: "[noun] + بَرایِ + [body part] + خوب/بَد + اَست",
        patternTransliteration: "[noun] + barāye + [body part] + khub/bad + ast",
        patternParts: ["[noun]", "بَرایِ", "[body part]", "خوب/بَد", "اَست"],
        patternExamples: [
          { persian: "آب بَرایِ پوست خوب اَست", transliteration: "āb barāye poost khub ast", english: "Water is good for the skin" },
          { persian: "وَرزِش بَرایِ قَلب خوب اَست", transliteration: "varzesh barāye ghalb khub ast", english: "Exercise is good for the heart" },
          { persian: "میوه بَرایِ بَدَن خوب اَست", transliteration: "mive barāye badan khub ast", english: "Fruit is good for the body" },
        ],
        note: "بَرایِ (barāye) means 'for'. You can use it with many things: غَذایِ خوب بَرایِ بَدَن خوب اَست (good food is good for the body). خوب (khub) = good, بَد (bad) = bad.",
      },
    ],
    reading: [
      {
        id: 1,
        title: "At the Doctor",
        persianTitle: "دَر مَطَب",
        text: "دُکتُر: سَلام علی! حالَت خوب اَست؟\nعلی: سَلام دُکتُر. نَه، سَرَم دَرد می‌کُنَد.\nدُکتُر: دَهانَت را باز کُن. گِلویَت قِرمِز اَست.\nعلی: دَندونَم هَم دَرد می‌کُنَد.\nدُکتُر: چِشمَت را بِبَند. خوب اَست. فَردا بِهتَر می‌شَوی.\nعلی: مَمنون دُکتُر!",
        textTransliteration: "doktur: salām ali! hālat khub ast?\nali: salām doktur. na, saram dard mikonad.\ndoktur: dahānat rā bāz kon. geluyat ghermez ast.\nali: dandunamen ham dard mikonad.\ndoktur: cheshmat rā beband. khub ast. fardā behtar mishavi.\nali: mamnun doktur!",
        textTranslation: "Doctor: Hello Ali! Are you feeling well?\nAli: Hello doctor. No, my head hurts.\nDoctor: Open your mouth. Your throat is red.\nAli: My tooth also hurts.\nDoctor: Close your eyes. It's okay. Tomorrow you'll feel better.\nAli: Thank you doctor!",
        questions: [
          { question: "What hurts Ali?", options: ["His head and tooth", "His leg and foot", "His hand and back", "His stomach"], correctAnswer: 0 },
          { question: "What does the doctor tell Ali to do first?", options: ["Open his mouth", "Close his eyes", "Wash his hands", "Go home"], correctAnswer: 0 },
        ],
      },
      {
        id: 2,
        title: "My Family",
        persianTitle: "خانِوادِه مَن",
        text: "خواهَرِ مَن موی بُلَند دارَد. چِشمِ او قَهوِه‌ای اَست. اَبروهایِ او سیاه اَست.\nبَرادَرِ مَن موی کوتاه دارَد. بینی او کوچِک اَست و لَبِ او بُزُرگ اَست.\nمادَرَم می‌گویَد: صورَتِ شُما هَر دو قَشَنگ اَست!",
        textTransliteration: "khāhar-e man mu-ye boland dārad. cheshm-e u ghahve'i ast. abruhā-ye u siyāh ast.\nbarādar-e man mu-ye kutāh dārad. bini-ye u kuchek ast va lab-e u bozorg ast.\nmādaram miguyad: surat-e shomā har do ghashang ast!",
        textTranslation: "My sister has long hair. Her eyes are brown. Her eyebrows are black.\nMy brother has short hair. His nose is small and his lip is big.\nMy mother says: Both of your faces are beautiful!",
        questions: [
          { question: "What color are the sister's eyes?", options: ["Brown", "Blue", "Green", "Black"], correctAnswer: 0 },
          { question: "What does the mother say about their faces?", options: ["Both faces are beautiful", "The sister is prettier", "The brother has a nicer face", "They look the same"], correctAnswer: 0 },
        ],
      },
      {
        id: 3,
        title: "After Exercise",
        persianTitle: "بَعد اَز وَرزِش",
        text: "رضا: سَلام امیر! وَرزِش کَردی؟\nامیر: بَله! شانه‌هایَم خَسته اَست. پُشتَم هَم دَرد می‌کُنَد.\nرضا: دَستَت خوب اَست؟\nامیر: بَله، دَستَم خوب اَست. وَلی گَردَنَم دَرد می‌کُنَد.\nرضا: آب بُخور! آب بَرایِ بَدَن خوب اَست.\nامیر: راست می‌گویی. مَمنون!",
        textTransliteration: "rezā: salām amir! varzesh kardi?\namir: bale! shāne-hāyam khaste ast. poshtam ham dard mikonad.\nrezā: dastat khub ast?\namir: bale, dastam khub ast. vali gardanam dard mikonad.\nrezā: āb bokhor! āb barāye badan khub ast.\namir: rāst miguyi. mamnun!",
        textTranslation: "Reza: Hello Amir! Did you exercise?\nAmir: Yes! My shoulders are tired. My back also hurts.\nReza: Is your hand okay?\nAmir: Yes, my hand is fine. But my neck hurts.\nReza: Drink water! Water is good for the body.\nAmir: You're right. Thanks!",
        questions: [
          { question: "What hurts Amir after exercise?", options: ["His back and neck", "His hand and fingers", "His head and tooth", "His stomach"], correctAnswer: 0 },
          { question: "What does Reza suggest?", options: ["Drink water", "Go to the doctor", "Go home and rest", "Stop exercising"], correctAnswer: 0 },
        ],
      },
      {
        id: 4,
        title: "Washing Hands",
        persianTitle: "شُستَنِ دَست",
        text: "مادَر: بیا غَذا بُخور!\nسارا: بَله مادَر!\nمادَر: اَوَل دَستَت را بِشور!\nسارا: چَرا؟\nمادَر: دَستِ تمیز بَرایِ بَدَن خوب اَست. ناخُنَت هَم کَثیف اَست.\nسارا: باشه! دَستَم و اِنگِشتَم را می‌شورَم.",
        textTransliteration: "mādar: biyā ghazā bokhor!\nsārā: bale mādar!\nmādar: avval dastat rā beshur!\nsārā: cherā?\nmādar: dast-e tamiz barāye badan khub ast. nākhonat ham kasif ast.\nsārā: bāshe! dastam va engoshatam rā mishoram.",
        textTranslation: "Mother: Come eat food!\nSara: Yes mother!\nMother: First wash your hands!\nSara: Why?\nMother: Clean hands are good for the body. Your nails are also dirty.\nSara: OK! I'll wash my hands and fingers.",
        questions: [
          { question: "What should Sara do before eating?", options: ["Wash her hands", "Brush her teeth", "Comb her hair", "Change her clothes"], correctAnswer: 0 },
          { question: "Why should Sara wash her hands?", options: ["Clean hands are good for the body", "Her food is ready", "Her mother is angry", "It is morning"], correctAnswer: 0 },
        ],
      },
      {
        id: 5,
        title: "A Walk in the Park",
        persianTitle: "قَدَم زَدَن دَر پارک",
        text: "مریم: بیا قَدَم بِزَنیم!\nنیما: پایَم خَسته اَست. زانویَم هَم دَرد می‌کُنَد.\nمریم: هَوا خوب اَست. هَوایِ تازه بَرایِ ریه خوب اَست!\nنیما: راست می‌گویی. وَلی کَمَرَم دَرد دارَد.\nمریم: آرام راه می‌رَویم. قَدَم زَدَن بَرایِ قَلب هَم خوب اَست.\nنیما: باشه! بِرَویم!",
        textTransliteration: "maryam: biyā ghadam bezanim!\nnimā: pāyam khaste ast. zānuyam ham dard mikonad.\nmaryam: havā khub ast. havā-ye tāze barāye rie khub ast!\nnimā: rāst miguyi. vali kamaram dard dārad.\nmaryam: ārām rāh miravim. ghadam zadan barāye ghalb ham khub ast.\nnimā: bāshe! beravim!",
        textTranslation: "Maryam: Let's go for a walk!\nNima: My foot is tired. My knee also hurts.\nMaryam: The weather is nice. Fresh air is good for the lungs!\nNima: You're right. But my lower back hurts.\nMaryam: We'll walk slowly. Walking is also good for the heart.\nNima: OK! Let's go!",
        questions: [
          { question: "What is good for the lungs?", options: ["Fresh air", "Water", "Food", "Sleep"], correctAnswer: 0 },
          { question: "Why does Nima not want to walk at first?", options: ["His foot and knee hurt", "He is hungry", "The weather is bad", "He is sleepy"], correctAnswer: 0 },
        ],
      },
      {
        id: 6,
        title: "Learning About the Body",
        persianTitle: "یادگیری دَربارِه بَدَن",
        text: "مُعَلِم: بَچِه‌ها! اِمروز دَربارِه بَدَن یاد می‌گیریم.\nمُعَلِم: قَلب خون را دَر بَدَن می‌فِرِستَد. ریه هَوا می‌گیرَد.\nسارا: مغز چِه کار می‌کُنَد؟\nمُعَلِم: مغز فِکر می‌کُنَد! مغز بَرایِ بَدَن خِیلی مُهِم اَست.\nرضا: پوست چِه کار می‌کُنَد؟\nمُعَلِم: پوست بَدَن را حِفظ می‌کُنَد. آب بَرایِ پوست خوب اَست.",
        textTransliteration: "mo'alem: bache-hā! emruz darbāre-ye badan yād migirim.\nmo'alem: ghalb khun rā dar badan miferestad. rie havā migirad.\nsārā: maghz che kār mikonad?\nmo'alem: maghz fekr mikonad! maghz barāye badan kheyli mohemm ast.\nrezā: poost che kār mikonad?\nmo'alem: poost badan rā hefz mikonad. āb barāye poost khub ast.",
        textTranslation: "Teacher: Children! Today we learn about the body.\nTeacher: The heart sends blood through the body. The lungs take in air.\nSara: What does the brain do?\nTeacher: The brain thinks! The brain is very important for the body.\nReza: What does the skin do?\nTeacher: The skin protects the body. Water is good for the skin.",
        questions: [
          { question: "What does the heart do?", options: ["It sends blood through the body", "It takes in air", "It thinks", "It protects the body"], correctAnswer: 0 },
          { question: "What is very important for the body?", options: ["The brain", "Water", "Air", "Food"], correctAnswer: 0 },
        ],
      },
    ],
    writing: [
      { id: 0, type: "word-order", instruction: "Put the words in order to say 'My head hurts'", tiles: ["دَرد", "سَرَم", "می‌کُنَد"], correctOrder: ["سَرَم", "دَرد", "می‌کُنَد"] },
      { id: 1, type: "word-order", instruction: "Put the words in order to say 'The nose is big'", tiles: ["اَست", "بُزُرگ", "بینی"], correctOrder: ["بینی", "بُزُرگ", "اَست"] },
      { id: 2, type: "fill-blank", instruction: "Fill in the blank", sentence: "___ دَرد می‌کُنَد (My tooth hurts)", choices: ["دَندونَم", "آب", "نان", "میز"], correctChoice: "دَندونَم" },
      { id: 3, type: "fill-blank", instruction: "Fill in the blank", sentence: "مو ___ اَست (The hair is long)", choices: ["بُلَند", "گُرسنِه", "تِشنِه", "سَرد"], correctChoice: "بُلَند" },
      { id: 4, type: "build-word", targetWord: "صورَت", targetWordTransliteration: "surat", availableLetters: ["ص", "و", "ر", "ت"], description: "Build the word for 'face'" },
      { id: 5, type: "build-word", targetWord: "چِشم", targetWordTransliteration: "cheshm", availableLetters: ["چ", "ش", "م"], description: "Build the word for 'eye'" },
      { id: 6, type: "word-order", instruction: "Put the words in order to say 'My back hurts'", tiles: ["دَرد", "می‌کُنَد", "پُشتَم"], correctOrder: ["پُشتَم", "دَرد", "می‌کُنَد"] },
      { id: 7, type: "word-order", instruction: "Put the words in order to say 'My hand is cold'", tiles: ["اَست", "سَرد", "دَستَم"], correctOrder: ["دَستَم", "سَرد", "اَست"] },
      { id: 8, type: "fill-blank", instruction: "Fill in the blank", sentence: "___ خَسته اَست (The shoulder is tired)", choices: ["شانه", "نان", "آب", "میز"], correctChoice: "شانه" },
      { id: 9, type: "fill-blank", instruction: "Fill in the blank", sentence: "گَردَن ___ اَست (The neck is tired)", choices: ["خَسته", "گُرسنِه", "تِشنِه", "سیر"], correctChoice: "خَسته" },
      { id: 10, type: "build-word", targetWord: "گَردَن", targetWordTransliteration: "gardan", availableLetters: ["گ", "ر", "د", "ن"], description: "Build the word for 'neck'" },
      { id: 11, type: "build-word", targetWord: "اِنگِشت", targetWordTransliteration: "engosht", availableLetters: ["ا", "ن", "گ", "ش", "ت"], description: "Build the word for 'finger'" },
      { id: 12, type: "word-order", instruction: "Put the words in order to say 'My stomach hurts'", tiles: ["دَرد", "شِکَمَم", "می‌کُنَد"], correctOrder: ["شِکَمَم", "دَرد", "می‌کُنَد"] },
      { id: 13, type: "word-order", instruction: "Put the words in order to say 'Water is good for the skin'", tiles: ["اَست", "خوب", "بَرایِ", "پوست", "آب"], correctOrder: ["آب", "بَرایِ", "پوست", "خوب", "اَست"] },
      { id: 14, type: "fill-blank", instruction: "Fill in the blank", sentence: "___ فِکر می‌کُنَد (The brain thinks)", choices: ["مغز", "نان", "آب", "میز"], correctChoice: "مغز" },
      { id: 15, type: "fill-blank", instruction: "Fill in the blank", sentence: "قَلب تِند ___ (The heart beats fast)", choices: ["می‌زَنَد", "می‌خورَد", "می‌خوابَد", "می‌رَوَد"], correctChoice: "می‌زَنَد" },
      { id: 16, type: "build-word", targetWord: "شِکَم", targetWordTransliteration: "shekam", availableLetters: ["ش", "ک", "م"], description: "Build the word for 'stomach'" },
      { id: 17, type: "build-word", targetWord: "پوست", targetWordTransliteration: "poost", availableLetters: ["پ", "و", "س", "ت"], description: "Build the word for 'skin'" },
    ],
  },
  ...
  19: {
    ...
    vocabulary: [
      ...
      },
      {
        ...
        example: "حالِم خوب نیست. باید بِرَوَم خانه.",
        exampleTranslation: "I don't feel well. I should go home.",
      },
      {
        persian: "خَسته",
        transliteration: "khaste",
        english: "tired",
        example: "خِیلی خَسته هَستَم.",
      ...
      },
      {
        ...
        english: "I am cold",
        example: "سَردَم اَست. پالتو می‌خواهَم.",
        exampleTranslation: "I am cold. I want an overcoat.",
      },
      {
        persian: "گَرمَم اَست",
        transliteration: "garmam ast",
        english: "I am hot",
        example: "گَرمَم اَست. آب می‌خواهَم.",
        exampleTranslation: "I am hot. I want water.",
      },
      {
        persian: "سَردرد",
        transliteration: "sardard",
        english: "headache",
        example: "سَردرد دارَم.",
      ...
      },
      {
        ...
        transliteration: "behtar",
        english: "better",
        example: "حالَم بهتَر اَست.",
        exampleTranslation: "I feel better.",
      },
      {
        persian: "بَدتَر",
        transliteration: "badtar",
        english: "worse",
        example: "حالَم بَدتَر شُد.",
      ...
      },
      {
        ...
        english: "good / well",
        example: "حالَت خوب اَست؟",
        exampleTranslation: "Are you feeling well?",
      },
      {
        persian: "بَد",
        transliteration: "bad",
        english: "bad",
        example: "حالَم بَد اَست.",
      ...
      },
      {
        ...
        english: "shivering",
        example: "لَرْز دارَم.",
        exampleTranslation: "I am shivering.",
      },
      {
        persian: "ضَعیف",
        transliteration: "za'if",
        english: "weak",
        example: "بَدَنَم ضَعیف اَست.",
        exampleTranslation: "My body is weak.",
      },
      {
        persian: "قَوی",
        transliteration: "qavi",
        english: "strong",
        example: "او قَوی اَست.",
        exampleTranslation: "He/She is strong.",
      },
      {
        persian: "ناراحَت",
        transliteration: "nārāhat",
        english: "unwell / uncomfortable",
        example: "ناراحَت هَستَم.",
        exampleTranslation: "I am uncomfortable.",
      },
      {
        persian: "حال‌وروز",
        transliteration: "hāl-o-ruz",
        english: "overall condition",
        example: "حال‌وروزَت چِطور اَست؟",
        exampleTranslation: "How is your overall condition?",
      },
      {
        persian: "دُرُست",
        transliteration: "dorost",
        english: "healthy / okay",
        example: "زود دُرُست می‌شَوی.",
        exampleTranslation: "You'll get well soon.",
      },
      {
        persian: "بیمار",
        transliteration: "bimār",
        english: "ill / sick",
        example: "او بیمار اَست.",
        exampleTranslation: "He/She is ill.",
      },
      {
        persian: "نَفَس",
        ...
        english: "breath",
        example: "نَفَس بِکِش!",
        exampleTranslation: "Take a breath!",
      },
      {
        persian: "اِستِراحت",
        transliteration: "esterāhat",
        english: "rest",
        example: "باید اِستِراحت کُنی.",
        exampleTranslation: "You should rest.",
      },
      {
        persian: "خواب",
        transliteration: "khāb",
        english: "sleep",
        example: "خواب بَرایِ بَدَن خوب اَست.",
        exampleTranslation: "Sleep is good for the body.",
      },
      {
        persian: "اَندَکی",
    ...
    grammar: [
      {
        id: 0,
        type: "pattern-intro" as const,
        instruction: "Learn how to express bodily feelings in Persian",
        teachingContent: {
          title: "Expressing Bodily Feelings",
          explanation: "In Persian, to say you feel cold, hot, hungry, thirsty, or tired, you attach the possessive suffix ـَم (-am = my) directly to the adjective and add اَست. This is different from saying مَن سَرد هَستَم. For words ending in a consonant (like سَرد), add ـَم: سَردَم اَست. For words ending in a vowel (like خَسته), add ‌ام: خَسته‌ام.",
          examples: [
            { label: "I am cold", persian: "سَردَم اَست", description: "sardam ast" },
            { label: "I am hungry", persian: "گرسنه‌ام", description: "gorsne-am" },
            { label: "I am tired", persian: "خَسته‌ام", description: "khaste-am" },
          ],
        },
        question: "How do you say 'I am cold' in Persian?",
        options: ["سَردَم اَست", "مَن سَرد اَست", "سَرد مَن اَست", "مَن هَستَم سَرد"],
        correctAnswer: 0,
        explanation: "The pattern is: [adjective] + َم + اَست. So 'I am cold' is سَردَم اَست.",
        pattern: "[adjective] + َم + اَست",
        patternTransliteration: "[adjective] + -am + ast",
        patternParts: ["[adjective]", "َم", "اَست"],
        patternExamples: [
          { persian: "سَردَم اَست", transliteration: "sardam ast", english: "I am cold" },
          { persian: "گَرمَم اَست", transliteration: "garmam ast", english: "I am hot" },
          { persian: "گرسنه‌ام", transliteration: "gorsne-am", english: "I am hungry" },
        ],
        note: "Change the suffix for different people: ـَت (-at) = you, ـَش (-ash) = he/she. For example: سَردَت اَست (you are cold), سَردَش اَست (he/she is cold). This pattern is used for bodily feelings and sensations.",
      },
      {
        id: 1,
        type: "pattern-intro" as const,
        instruction: "Learn how to give health advice using 'should'",
        teachingContent: {
          title: "Using باید for Health Advice",
          explanation: "باید (bāyad) means 'must' or 'should'. To tell someone what they should do, use باید followed by the subjunctive verb form. For 'you should': باید + verb stem + ی. This is very useful for giving health advice.",
          examples: [
            { label: "You should drink water", persian: "باید آب بُخوری", description: "bāyad āb bokhori" },
            { label: "You should eat food", persian: "باید غَذا بُخوری", description: "bāyad ghazā bokhori" },
            { label: "You should go home", persian: "باید بِرَوی خانه", description: "bāyad beravi khāne" },
          ],
        },
        question: "How do you say 'You should drink water'?",
        options: ["باید آب بُخوری", "آب باید بُخوری", "بُخوری باید آب", "باید بُخوری آب"],
        correctAnswer: 0,
        explanation: "The pattern is: باید + [verb]. So 'You should drink water' is باید آب بُخوری.",
        pattern: "باید + [verb]",
        patternTransliteration: "bāyad + [verb]",
        patternParts: ["باید", "[verb]"],
        patternExamples: [
          { persian: "باید آب بُخوری", transliteration: "bāyad āb bokhori", english: "You should drink water" },
          { persian: "باید غَذا بُخوری", transliteration: "bāyad ghazā bokhori", english: "You should eat food" },
          { persian: "باید بِرَوی خانه", transliteration: "bāyad beravi khāne", english: "You should go home" },
        ],
        note: "باید works with different subjects: باید بِخوابَم (I should sleep), باید بِخوابی (you should sleep), باید بِخوابَد (he/she should sleep). The verb after باید uses the subjunctive form with the prefix بِـ (be-).",
      },
      {
        id: 2,
        type: "pattern-intro" as const,
        instruction: "Learn how to say you cannot do something",
        teachingContent: {
          title: "Saying You Cannot Do Something",
          explanation: "نِمی‌تَوانَم (nemitavānam) means 'I cannot' or 'I am not able to'. Use it before a verb to say what you can't do. This is useful when you are sick or unwell and need to describe what you can't do.",
          examples: [
            { label: "I can't sleep", persian: "نِمی‌تَوانَم بِخوابَم", description: "nemitavānam bekhābam" },
            { label: "I can't breathe", persian: "نِمی‌تَوانَم نَفَس بِکِشَم", description: "nemitavānam nafas bekesham" },
            { label: "I can't eat", persian: "نِمی‌تَوانَم غَذا بُخورَم", description: "nemitavānam ghazā bokhoram" },
          ],
        },
        question: "How do you say 'I can't sleep'?",
        options: ["نِمی‌تَوانَم بِخوابَم", "نِمی‌خوابَم تَوانَم", "بِخوابَم نِمی‌تَوانَم", "مَن خواب نیست"],
        correctAnswer: 0,
        explanation: "The pattern is: نِمی‌تَوانَم + [verb]. So 'I can't sleep' is نِمی‌تَوانَم بِخوابَم.",
        pattern: "نِمی‌تَوانَم + [verb]",
        patternTransliteration: "nemitavānam + [verb]",
        patternParts: ["نِمی‌تَوانَم", "[verb]"],
        patternExamples: [
          { persian: "نِمی‌تَوانَم بِخوابَم", transliteration: "nemitavānam bekhābam", english: "I can't sleep" },
          { persian: "نِمی‌تَوانَم نَفَس بِکِشَم", transliteration: "nemitavānam nafas bekesham", english: "I can't breathe" },
          { persian: "نِمی‌تَوانَم غَذا بُخورَم", transliteration: "nemitavānam ghazā bokhoram", english: "I can't eat" },
        ],
        note: "The positive form is می‌تَوانَم (I can). For other subjects: نِمی‌تَوانی (you can't), نِمی‌تَوانَد (he/she can't). The verb after نِمی‌تَوانَم uses the subjunctive form with بِـ (be-).",
      },
    ],
    reading: [
      {
        ...
        persianTitle: "حالِم خوب نیست",
        text: "سارا: سَلام مریم! حالَت خوب اَست؟\nمریم: نَه، حالِم خوب نیست. خَسته‌ام.\nسارا: گرسنه هَستی؟ بیا نان بُخور!\nمریم: نَه، سیر هَستَم. فَقَط تَشنه‌ام.\nسارا: آب بیاوَرَم؟\nمریم: بَله، لُطفاً. مَمنون!",
        textTransliteration: "sārā: salām maryam! hālat khub ast?\nmaryam: na, hālam khub nist. khaste-am.\nsārā: gorsne hasti? biyā nān bokhor!\nmaryam: na, sir hastam. faghat tashne-am.\nsārā: āb biyāvaram?\nmaryam: bale, lotfan. mamnun!",
        textTranslation: "Sara: Hello Maryam! Are you feeling well?\nMaryam: No, I don't feel well. I am tired.\nSara: Are you hungry? Come eat bread!\nMaryam: No, I am full. I am just thirsty.\nSara: Should I bring water?\nMaryam: Yes, please. Thank you!",
        questions: [
          { question: "How does Maryam feel?", options: ["Tired and thirsty", "Hungry and cold", "Happy and warm", "Angry and sick"], correctAnswer: 0 },
          { question: "What does Maryam want?", options: ["Water", "Bread", "Tea", "Nothing"], correctAnswer: 0 },
        ],
      },
      {
        id: 2,
        title: "After a Long Day",
        persianTitle: "بَعد اَز یِک روزِ طولانی",
        text: "امیر: سَلام مادَر! خَسته‌ام.\nمادَر: بیا بِنِشین! گرسنه هَستی؟\nامیر: بَله، خِیلی گرسنه‌ام. سَردَم هَم اَست.\nمادَر: غَذا آمادِه اَست. چای هَم گَرم اَست.\nامیر: مَمنون مادَر! دَرد دارَم. پایَم دَرد می‌کُنَد.\nمادَر: بَعد اَز غَذا خوب می‌شَوی.",
        textTransliteration: "amir: salām mādar! khaste-am.\nmādar: biyā benishin! gorsne hasti?\namir: bale, kheyli gorsne-am. sardam ham ast.\nmādar: ghazā āmāde ast. chāy ham garm ast.\namir: mamnun mādar! dard dāram. pāyam dard mikonad.\nmādar: ba'd az ghazā khub mishavi.",
        textTranslation: "Amir: Hello mother! I am tired.\nMother: Come sit down! Are you hungry?\nAmir: Yes, I am very hungry. I am also cold.\nMother: Food is ready. Tea is also warm.\nAmir: Thanks mother! I am in pain. My foot hurts.\nMother: After food you'll feel better.",
        questions: [
          { question: "What is ready at home?", options: ["Food and warm tea", "Just food", "Just tea", "Nothing"], correctAnswer: 0 },
          { question: "What hurts Amir?", options: ["His foot", "His head", "His hand", "His stomach"], correctAnswer: 0 },
        ],
      },
      {
        id: 3,
        title: "A Phone Call",
        persianTitle: "تِلِفون زَدَن",
        text: "رضا: مادَر! مَن مَریض هَستَم.\nمادَر: چِه شُده؟ کُجایَت دَرد می‌کُنَد؟\nرضا: سَردرد دارَم. تَب هَم دارَم.\nمادَر: دَردِ شِکَم هَم داری؟\nرضا: بَله. حالَم بَد اَست. لَرْز هَم دارَم.\nمادَر: الآن می‌آیَم!",
        textTransliteration: "rezā: mādar! man mariz hastam.\nmādar: che shode? kojāyat dard mikonad?\nrezā: sardard dāram. tab ham dāram.\nmādar: dard-e shekam ham dāri?\nrezā: bale. hālam bad ast. larz ham dāram.\nmādar: al'ān miyāyam!",
        textTranslation: "Reza: Mom! I am sick.\nMother: What happened? Where does it hurt?\nReza: I have a headache. I also have a fever.\nMother: Do you also have a stomachache?\nReza: Yes. I feel bad. I'm also shivering.\nMother: I'm coming right now!",
        questions: [
          { question: "What symptoms does Reza have?", options: ["Headache, fever, stomachache, and shivering", "Just a headache", "Just a fever", "Just a stomachache"], correctAnswer: 0 },
          { question: "What is the mother going to do?", options: ["Come to Reza right away", "Call the doctor", "Send medicine", "Tell him to rest"], correctAnswer: 0 },
        ],
      },
      {
        id: 4,
        title: "Getting Better",
        persianTitle: "بهتَر شُدَن",
        text: "مریم: حالَت بهتَر اَست؟\nعلی: بَله، دیروز حالَم بَد بود. اِمروز بهتَر هَستَم.\nمریم: تَب داری؟\nعلی: نَه، تَبَم رَفته. وَلی هَنوز سَردرد دارَم.\nمریم: آب بُخور. آب بَرایِ بَدَن خوب اَست.\nعلی: راست می‌گویی. حالَم هَر روز بهتَر می‌شَوَد.",
        textTransliteration: "maryam: hālat behtar ast?\nali: bale, diruz hālam bad bud. emruz behtar hastam.\nmaryam: tab dāri?\nali: na, tabam rafte. vali hanuz sardard dāram.\nmaryam: āb bokhor. āb barāye badan khub ast.\nali: rāst miguyi. hālam har ruz behtar mishavad.",
        textTranslation: "Maryam: Are you feeling better?\nAli: Yes, yesterday I felt bad. Today I'm better.\nMaryam: Do you have a fever?\nAli: No, my fever is gone. But I still have a headache.\nMaryam: Drink water. Water is good for the body.\nAli: You're right. I feel better every day.",
        questions: [
          { question: "How does Ali feel today compared to yesterday?", options: ["Better", "Worse", "The same", "He doesn't know"], correctAnswer: 0 },
          { question: "Does Ali still have a fever?", options: ["No, the fever is gone", "Yes, he still has a fever", "He doesn't know", "Yes, a high fever"], correctAnswer: 0 },
        ],
      },
      {
        id: 5,
        title: "A Sick Day",
        persianTitle: "یِک روزِ بیماری",
        text: "نیما: مادَر! بیمار هَستَم. خِیلی ضَعیف هَستَم.\nمادَر: باید اِستِراحت کُنی. بیا بِخواب!\nنیما: نِمی‌تَوانَم بِخوابَم. ناراحَت هَستَم.\nمادَر: اَندَکی آب بُخور. خواب بَرایِ بَدَن خوب اَست.\nنیما: باشه. مَمنون مادَر.\nمادَر: فَردا بهتَر می‌شَوی. قَوی هَستی!",
        textTransliteration: "nimā: mādar! bimār hastam. kheyli za'if hastam.\nmādar: bāyad esterāhat koni. biyā bekhāb!\nnimā: nemitavānam bekhābam. nārāhat hastam.\nmādar: andaki āb bokhor. khāb barāye badan khub ast.\nnimā: bāshe. mamnun mādar.\nmādar: fardā behtar mishavi. qavi hasti!",
        textTranslation: "Nima: Mom! I am sick. I am very weak.\nMom: You should rest. Come sleep!\nNima: I can't sleep. I am uncomfortable.\nMom: Drink a little water. Sleep is good for the body.\nNima: OK. Thanks mom.\nMom: Tomorrow you'll feel better. You are strong!",
        questions: [
          { question: "Why can't Nima sleep?", options: ["He is uncomfortable", "He is hungry", "He is thirsty", "He wants to play"], correctAnswer: 0 },
          { question: "What does mom say about tomorrow?", options: ["He will feel better", "He should go to the doctor", "He should eat", "He will feel worse"], correctAnswer: 0 },
        ],
      },
      {
        id: 6,
        title: "The Doctor's Advice",
        persianTitle: "نَصیحَتِ دُکتُر",
        text: "دُکتُر: حال‌وروزَت چِطور اَست؟\nسارا: خوب نیست. بیمار هَستَم. ضَعیف هَستَم.\nدُکتُر: باید اِستِراحت کُنی. خواب خِیلی مُهِم اَست.\nسارا: چَند روز?\nدُکتُر: سه روز اِستِراحت کُن. آب زیاد بُخور.\nسارا: بهتَر می‌شَوَم؟\nدُکتُر: بَله! بَدَنَت قَوی اَست. زود دُرُست می‌شَوی.",
        textTransliteration: "doktur: hāl-o-ruzat chetor ast?\nsārā: khub nist. bimār hastam. za'if hastam.\ndoktur: bāyad esterāhat koni. khāb kheyli mohemm ast.\nsārā: chand ruz?\ndoktur: se ruz esterāhat kon. āb ziyād bokhor.\nsārā: behtar mishavam?\ndoktur: bale! badanat qavi ast. zud dorost mishavi.",
        textTranslation: "Doctor: How is your overall condition?\nSara: Not good. I am ill. I am weak.\nDoctor: You should rest. Sleep is very important.\nSara: How many days?\nDoctor: Rest for three days. Drink lots of water.\nSara: Will I get better?\nDoctor: Yes! Your body is strong. You'll get well soon.",
        questions: [
          { question: "How many days should Sara rest?", options: ["Three days", "One day", "One week", "Two days"], correctAnswer: 0 },
          { question: "What does the doctor say about Sara's body?", options: ["It is strong", "It is weak", "It is sick", "It needs medicine"], correctAnswer: 0 },
        ],
      },
    ],
    writing: [
      { id: 0, type: "word-order", instruction: "Put the words in order to say 'I am tired'", tiles: ["هَستَم", "خَسته", "مَن"], correctOrder: ["مَن", "خَسته", "هَستَم"] },
      { id: 1, type: "word-order", instruction: "Put the words in order to say 'I am sick'", tiles: ["هَستَم", "مَریض", "مَن"], correctOrder: ["مَن", "مَریض", "هَستَم"] },
      { id: 2, type: "fill-blank", instruction: "Fill in the blank", sentence: "مَن ___ هَستَم (I am hungry)", choices: ["گرسنه", "آب", "نان", "میز"], correctChoice: "گرسنه" },
      { id: 3, type: "fill-blank", instruction: "Fill in the blank", sentence: "___ خوب نیست (I don't feel well)", choices: ["حالِم", "غَذا", "کِتاب", "میز"], correctChoice: "حالِم" },
      { id: 4, type: "build-word", targetWord: "مَریض", targetWordTransliteration: "mariz", availableLetters: ["م", "ر", "ی", "ض"], description: "Build the word for 'sick'" },
      { id: 5, type: "build-word", targetWord: "خَسته", targetWordTransliteration: "khaste", availableLetters: ["خ", "س", "ت", "ه"], description: "Build the word for 'tired'" },
      { id: 6, type: "word-order", instruction: "Put the words in order to say 'I have a fever'", tiles: ["دارَم", "تَب", "مَن"], correctOrder: ["مَن", "تَب", "دارَم"] },
      { id: 7, type: "word-order", instruction: "Put the words in order to say 'I feel better'", tiles: ["اَست", "بهتَر", "حالَم"], correctOrder: ["حالَم", "بهتَر", "اَست"] },
      { id: 8, type: "fill-blank", instruction: "Fill in the blank", sentence: "مَن ___ دارَم (I have a headache)", choices: ["سَردرد", "آب", "نان", "میز"], correctChoice: "سَردرد" },
      { id: 9, type: "fill-blank", instruction: "Fill in the blank", sentence: "حالَم ___ اَست (I feel worse)", choices: ["بَدتَر", "گرسنه", "تَشنه", "سیر"], correctChoice: "بَدتَر" },
      { id: 10, type: "build-word", targetWord: "بهتَر", targetWordTransliteration: "behtar", availableLetters: ["ب", "ه", "ت", "ر"], description: "Build the word for 'better'" },
      { id: 11, type: "build-word", targetWord: "حال", targetWordTransliteration: "hāl", availableLetters: ["ح", "ا", "ل"], description: "Build the word for 'condition'" },
      { id: 12, type: "word-order", instruction: "Put the words in order to say 'You should rest'", tiles: ["کُنی", "اِستِراحت", "باید"], correctOrder: ["باید", "اِستِراحت", "کُنی"] },
      { id: 13, type: "word-order", instruction: "Put the words in order to say 'Sleep is good for the body'", tiles: ["اَست", "خوب", "بَرایِ", "بَدَن", "خواب"], correctOrder: ["خواب", "بَرایِ", "بَدَن", "خوب", "اَست"] },
      { id: 14, type: "fill-blank", instruction: "Fill in the blank", sentence: "باید ___ کُنی (You should rest)", choices: ["اِستِراحت", "غَذا", "نان", "آب"], correctChoice: "اِستِراحت" },
      { id: 15, type: "fill-blank", instruction: "Fill in the blank", sentence: "او ___ اَست (He/She is weak)", choices: ["ضَعیف", "گرسنه", "سیر", "تَشنه"], correctChoice: "ضَعیف" },
      { id: 16, type: "build-word", targetWord: "خواب", targetWordTransliteration: "khāb", availableLetters: ["خ", "و", "ا", "ب"], description: "Build the word for 'sleep'" },
      { id: 17, type: "build-word", targetWord: "نَفَس", targetWordTransliteration: "nafas", availableLetters: ["ن", "ف", "س"], description: "Build the word for 'breath'" },
    ],
  },
