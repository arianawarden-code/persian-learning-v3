...
export function ModuleCard({ module, progress = 0 }: { module: Module; progress?: number }) {
  ...
  return (
    <Link href={`/modules/${module.id}`} className="h-full">
      <Card className="group flex h-full cursor-pointer flex-col border-sand-200 bg-white px-6 py-5 transition-all hover:shadow-lg">
        ...
        <p className="mb-4 flex-1 leading-relaxed text-charcoal/70">{module.description}</p>
